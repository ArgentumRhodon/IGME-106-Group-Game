...
namespace IGME106GroupGame.UI.Menus
{
    class PauseUI : UserInterface
    {
        ...
        {
            images.Add(new Image(Assets.Get("pausedTitle"), 0, -150, Alignment.Middle, Alignment.Middle, game.Graphics));
            ...
            buttons.Add(new Button(new Image(Assets.Get("continueText"), 0, 100, Alignment.Middle, Alignment.Middle, game.Graphics), (State state) => { ((GameState)state).IsPaused = false; }));
        }
    }
}
