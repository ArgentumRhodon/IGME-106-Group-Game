...
namespace HW2
{
    public partial class LevelEditor : Form
    {
        ...
        public LevelEditor(int mapWidth, int mapHeight, Form1 form)
        {
            ...
            this.changes = false;
            this.form = form;
            //Size = new Size((Width - groupBoxMap.Width) + groupBoxMap.Width * (Width / Height), (Height - groupBoxMap.Height) + groupBoxMap.Height * (Width / Height));
        ...
        public void CreateMap(int[] colors)
        {
            for (int y = 0; y < mapHeight; y++)
            {
                for (int x = 0; x < mapWidth; x++)
                {
                    ...
                    pb.Click += pictureBoxColorAssign;
        ...
        /// <summary>
        /// This overload of CreateMap will fill the map with one default color
        /// </summary>
        /// <param name="color"></param>
        public void CreateMap(Color color)
        {
            for (int y = 0; y < mapHeight; y++)
            {
                for (int x = 0; x < mapWidth; x++)
        ...
        /// <summary>
        /// This method will change the pictureBox clicked on to the selected color
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void pictureBoxColorAssign(object sender, EventArgs e)
        {
            PictureBox pb = (PictureBox)sender;
            pb.BackColor = buttonCurrentTile.BackColor;
        }
